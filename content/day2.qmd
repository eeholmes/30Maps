...
[https://milospopovic.net/mapping-wind-data-in-r/](https://milospopovic.net/mapping-wind-data-in-r/) using his code.
...
```{r}
df2 <- data.frame(x=eur_wind_df$lon, y=eur_wind_df$lat, z=eur_wind_df$speed)
